...
\begin{problema}
Para cada $n\in\mathbb{N}$ defina $s(n)=\sum_{k=1}^n\frac{1}{k}$. Prove que o conjunto $A=\{s(n):n\in\mathbb{N}\}$ não é limitado superiormente.
\end{problema}
